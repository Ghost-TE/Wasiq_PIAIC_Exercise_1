...
// A dog would make a great pet. • Add a line at the end of your program stating what 
// these animals have in common. You could print a sentence such as Any of these animals 
// would make a great pet!

var animals : String [];
animals = ["Markhor","Ibex","Deer"];

for(var i = 0; i< animals.length; i++){
    console.log("A "+animals[i]+" would make a great pet");
}
console.log("All of the 3 animals are intelligent and any of them would make a great pet");
